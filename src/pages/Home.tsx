...
import { BarChart3, Gauge, MessageSquare, MousePointerClick, Network, Search, ShieldCheck, TrendingUp } from 'lucide-react';
...
export function Home() {
  const faqItems = [
    { title: "Kolik stojí web?", content: "Nový web obvykle začíná od 35 000 Kč. Redesign nefunkčního nebo zastaralého webu většinou začíná od 60 000 Kč. Rozšíření a úpravy webu řeším individuálně podle rozsahu. Péče po spuštění navazuje měsíčním paušálem podle toho, co budete pravidelně potřebovat." },
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                { icon: BarChart3, title: 'Chybějící měření' },
                { icon: Network, title: 'Špatná struktura' },
                { icon: Gauge, title: 'Pomalý web' },
                { icon: MousePointerClick, title: 'Nízká konverze' },
                { icon: TrendingUp, title: 'Slabý prodej' },
              ].map((item) => (
      ...
      >
        ...
        <div className="container mx-auto max-w-6xl relative z-10 mix-blend-difference">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
            {[
              { title: "Služby a živnostníci", desc: "Když prodáváte znalost, zkušenost nebo osobní přístup a web musí vysvětlit, proč má klient oslovit právě vás.", link: "/sluzby/tvorba-webu", linkText: "Web pro služby" },
              { title: "Firmy", desc: "Když máte nabídku, která dává smysl, ale web ji neumí strukturovat, zjednodušit a přeložit do jazyka zákazníka.", link: "/sluzby/tvorba-webu", linkText: "Web pro firmu" },
              { title: "Podnikání založené na důvěře", desc: "Když potřebujete působit důvěryhodně, být dohledatelní a vést lidi rychle ke kontaktu, domluvě schůzky nebo návštěvě.", link: "/sluzby/tvorba-webu", linkText: "Web pro služby" },
              { title: "Web bez výsledků", desc: "Když současný web nepůsobí profesionálně, špatně se čte na mobilu nebo už neodpovídá tomu, co dnes nabízíte.", link: "/sluzby/redesign-webu", linkText: "Redesign webu" }
            ].map((item, i) => (
              <motion.div
                key={i}
